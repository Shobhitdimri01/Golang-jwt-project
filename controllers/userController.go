...
import (
	...
	"github.com/Shobhitdimri01/jwt-project/database"
	helper "github.com/Shobhitdimri01/jwt-project/helpers"
	"github.com/Shobhitdimri01/jwt-project/models"
...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			log.Panic(err)
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occurred while checking phone no"})
		}
		if count > 0 {
